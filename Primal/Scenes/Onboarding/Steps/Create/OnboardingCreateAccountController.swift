...
private extension OnboardingCreateAccountController {
    ...
    func setup() {
        ...
        lazy var progressView = UIView()//PrimalProgressView(progress: 1, total: 3)
...
//            }
            ...
            let profileVC = OnboardingProfileController(data: data, uploader: nil)
            profileVC.profileView.profileImageView.image = avatarView.image
            profileVC.profileView.coverImageView.image = bannerImageView.image
