...
class LongFormEmbeddedPostCell: PostCell {
...
private extension LongFormEmbeddedPostCell {
    func setup() {
...
//        postPreview.backgroundColor = .background4
        
        cardView.addSubview(mainStack)
    
        let bottomC = mainStack.bottomAnchor.constraint(equalTo: cardView.bottomAnchor, constant: -12)
