...
/**
 * @note This method converts instances of ZapException, CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)zapData:(PrimalSharedZapRequestData *)data completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("zap(data:completionHandler:)")));
@end
...
__attribute__((swift_name("ZapException")))
@interface PrimalSharedZapException : PrimalSharedKotlinRuntimeException
@property (readonly) PrimalSharedKotlinThrowable * _Nullable cause __attribute__((swift_name("cause")));
@property (readonly) NSString * _Nullable message __attribute__((swift_name("message")));
- (instancetype)initWithMessage:(NSString * _Nullable)message cause:(PrimalSharedKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(message:cause:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ZapFailureException")))
@interface PrimalSharedZapFailureException : PrimalSharedZapException
@property (readonly) PrimalSharedKotlinThrowable * _Nullable cause __attribute__((swift_name("cause")));
@property (readonly) NSString * _Nullable message __attribute__((swift_name("message")));
- (instancetype)initWithMessage:(NSString * _Nullable)message cause:(PrimalSharedKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(message:cause:)"))) __attribute__((objc_designated_initializer));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ZapRequestException")))
@interface PrimalSharedZapRequestException : PrimalSharedZapException
@property (readonly) PrimalSharedKotlinThrowable * _Nullable cause __attribute__((swift_name("cause")));
@property (readonly) NSString * _Nullable message __attribute__((swift_name("message")));
- (instancetype)initWithMessage:(NSString * _Nullable)message cause:(PrimalSharedKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(message:cause:)"))) __attribute__((objc_designated_initializer));
@end
...
+ (void)Skie_Suspend__100__findProfileDataDispatchReceiver:(id<PrimalSharedProfileRepository>)dispatchReceiver profileIds:(NSArray<NSString *> *)profileIds suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__100__findProfileData(dispatchReceiver:profileIds:suspendHandler:)")));
+ (void)Skie_Suspend__101__findProfileDataOrNullDispatchReceiver:(id<PrimalSharedProfileRepository>)dispatchReceiver profileId:(NSString *)profileId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__101__findProfileDataOrNull(dispatchReceiver:profileId:suspendHandler:)")));
+ (void)Skie_Suspend__102__findProfileStatsDispatchReceiver:(id<PrimalSharedProfileRepository>)dispatchReceiver profileIds:(NSArray<NSString *> *)profileIds suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__102__findProfileStats(dispatchReceiver:profileIds:suspendHandler:)")));
+ (void)Skie_Suspend__103__isUserFollowingDispatchReceiver:(id<PrimalSharedProfileRepository>)dispatchReceiver userId:(NSString *)userId targetUserId:(NSString *)targetUserId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__103__isUserFollowing(dispatchReceiver:userId:targetUserId:suspendHandler:)")));
+ (void)Skie_Suspend__104__reportAbuseDispatchReceiver:(id<PrimalSharedProfileRepository>)dispatchReceiver userId:(NSString *)userId reportType:(PrimalSharedReportType *)reportType profileId:(NSString *)profileId eventId:(NSString * _Nullable)eventId articleId:(NSString * _Nullable)articleId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__104__reportAbuse(dispatchReceiver:userId:reportType:profileId:eventId:articleId:suspendHandler:)")));
+ (void)Skie_Suspend__105__importEventsDispatchReceiver:(id<PrimalSharedNostrEventImporter>)dispatchReceiver events:(NSArray<PrimalSharedNostrEvent *> *)events suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__105__importEvents(dispatchReceiver:events:suspendHandler:)")));
+ (void)Skie_Suspend__106__signPublishImportNostrEventDispatchReceiver:(id<PrimalSharedPrimalPublisher>)dispatchReceiver unsignedNostrEvent:(PrimalSharedNostrUnsignedEvent *)unsignedNostrEvent outboxRelays:(NSArray<NSString *> *)outboxRelays suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__106__signPublishImportNostrEvent(dispatchReceiver:unsignedNostrEvent:outboxRelays:suspendHandler:)")));
+ (void)Skie_Suspend__107__deleteArticleByATagDispatchReceiver:(id<PrimalSharedArticleRepository>)dispatchReceiver articleATag:(NSString *)articleATag suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__107__deleteArticleByATag(dispatchReceiver:articleATag:suspendHandler:)")));
+ (void)Skie_Suspend__108__fetchArticleAndCommentsDispatchReceiver:(id<PrimalSharedArticleRepository>)dispatchReceiver userId:(NSString *)userId articleId:(NSString *)articleId articleAuthorId:(NSString *)articleAuthorId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__108__fetchArticleAndComments(dispatchReceiver:userId:articleId:articleAuthorId:suspendHandler:)")));
+ (void)Skie_Suspend__109__fetchArticleHighlightsDispatchReceiver:(id<PrimalSharedArticleRepository>)dispatchReceiver userId:(NSString *)userId articleId:(NSString *)articleId articleAuthorId:(NSString *)articleAuthorId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__109__fetchArticleHighlights(dispatchReceiver:userId:articleId:articleAuthorId:suspendHandler:)")));
...
+ (void)Skie_Suspend__110__getArticleByATagDispatchReceiver:(id<PrimalSharedArticleRepository>)dispatchReceiver aTag:(NSString *)aTag suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__110__getArticleByATag(dispatchReceiver:aTag:suspendHandler:)")));
+ (void)Skie_Suspend__111__observeArticleDispatchReceiver:(id<PrimalSharedArticleRepository>)dispatchReceiver articleId:(NSString *)articleId articleAuthorId:(NSString *)articleAuthorId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__111__observeArticle(dispatchReceiver:articleId:articleAuthorId:suspendHandler:)")));
+ (void)Skie_Suspend__112__observeArticleByCommentIdDispatchReceiver:(id<PrimalSharedArticleRepository>)dispatchReceiver commentNoteId:(NSString *)commentNoteId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__112__observeArticleByCommentId(dispatchReceiver:commentNoteId:suspendHandler:)")));
+ (void)Skie_Suspend__113__observeArticleByEventIdDispatchReceiver:(id<PrimalSharedArticleRepository>)dispatchReceiver eventId:(NSString *)eventId articleAuthorId:(NSString *)articleAuthorId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__113__observeArticleByEventId(dispatchReceiver:eventId:articleAuthorId:suspendHandler:)")));
+ (void)Skie_Suspend__114__observeArticleCommentsDispatchReceiver:(id<PrimalSharedArticleRepository>)dispatchReceiver userId:(NSString *)userId articleId:(NSString *)articleId articleAuthorId:(NSString *)articleAuthorId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__114__observeArticleComments(dispatchReceiver:userId:articleId:articleAuthorId:suspendHandler:)")));
+ (void)Skie_Suspend__115__getHighlightByIdDispatchReceiver:(id<PrimalSharedHighlightRepository>)dispatchReceiver highlightId:(NSString *)highlightId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__115__getHighlightById(dispatchReceiver:highlightId:suspendHandler:)")));
+ (void)Skie_Suspend__116__publishAndSaveHighlightDispatchReceiver:(id<PrimalSharedHighlightRepository>)dispatchReceiver userId:(NSString *)userId content:(NSString *)content referencedEventATag:(NSString * _Nullable)referencedEventATag referencedEventAuthorTag:(NSString * _Nullable)referencedEventAuthorTag context:(NSString * _Nullable)context alt:(NSString *)alt createdAt:(int64_t)createdAt suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__116__publishAndSaveHighlight(dispatchReceiver:userId:content:referencedEventATag:referencedEventAuthorTag:context:alt:createdAt:suspendHandler:)")));
+ (void)Skie_Suspend__117__publishDeleteHighlightDispatchReceiver:(id<PrimalSharedHighlightRepository>)dispatchReceiver userId:(NSString *)userId highlightId:(NSString *)highlightId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__117__publishDeleteHighlight(dispatchReceiver:userId:highlightId:suspendHandler:)")));
+ (void)Skie_Suspend__118__clearUserDataDispatchReceiver:(id<PrimalSharedUserDataCleanupRepository>)dispatchReceiver userId:(NSString *)userId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__118__clearUserData(dispatchReceiver:userId:suspendHandler:)")));
+ (void)Skie_Suspend__119__headMediaDispatchReceiver:(id<PrimalSharedBlossomApi>)dispatchReceiver authorization:(NSString *)authorization fileMetadata:(PrimalSharedFileMetadata *)fileMetadata suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__119__headMedia(dispatchReceiver:authorization:fileMetadata:suspendHandler:)")));
...
+ (void)Skie_Suspend__120__headUploadDispatchReceiver:(id<PrimalSharedBlossomApi>)dispatchReceiver authorization:(NSString *)authorization fileMetadata:(PrimalSharedFileMetadata *)fileMetadata suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__120__headUpload(dispatchReceiver:authorization:fileMetadata:suspendHandler:)")));
+ (void)Skie_Suspend__121__putMediaDispatchReceiver:(id<PrimalSharedBlossomApi>)dispatchReceiver authorization:(NSString *)authorization fileMetadata:(PrimalSharedFileMetadata *)fileMetadata bufferedSource:(id<PrimalSharedOkioBufferedSource>)bufferedSource onProgress:(void (^ _Nullable)(PrimalSharedInt *, PrimalSharedInt *))onProgress suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__121__putMedia(dispatchReceiver:authorization:fileMetadata:bufferedSource:onProgress:suspendHandler:)")));
+ (void)Skie_Suspend__122__putMirrorDispatchReceiver:(id<PrimalSharedBlossomApi>)dispatchReceiver authorization:(NSString *)authorization fileUrl:(NSString *)fileUrl suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__122__putMirror(dispatchReceiver:authorization:fileUrl:suspendHandler:)")));
+ (void)Skie_Suspend__123__putUploadDispatchReceiver:(id<PrimalSharedBlossomApi>)dispatchReceiver authorization:(NSString *)authorization fileMetadata:(PrimalSharedFileMetadata *)fileMetadata bufferedSource:(id<PrimalSharedOkioBufferedSource>)bufferedSource onProgress:(void (^ _Nullable)(PrimalSharedInt *, PrimalSharedInt *))onProgress suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__123__putUpload(dispatchReceiver:authorization:fileMetadata:bufferedSource:onProgress:suspendHandler:)")));
+ (void)Skie_Suspend__124__provideBlossomServerListDispatchReceiver:(id<PrimalSharedBlossomServerListProvider>)dispatchReceiver userId:(NSString *)userId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__124__provideBlossomServerList(dispatchReceiver:userId:suspendHandler:)")));
+ (void)Skie_Suspend__125__uploadDispatchReceiver:(PrimalSharedIosPrimalBlossomUploadService *)dispatchReceiver path:(NSString *)path userId:(NSString *)userId onProgress:(void (^ _Nullable)(PrimalSharedInt *, PrimalSharedInt *))onProgress suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__125__upload(dispatchReceiver:path:userId:onProgress:suspendHandler:)")));
+ (void)Skie_Suspend__126__uploadDispatchReceiver:(PrimalSharedIosPrimalBlossomUploadService *)dispatchReceiver path:(NSString *)path userId:(NSString *)userId onSignRequested:(PrimalSharedNostrEvent *(^)(PrimalSharedNostrUnsignedEvent *))onSignRequested onProgress:(void (^ _Nullable)(PrimalSharedInt *, PrimalSharedInt *))onProgress suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__126__upload(dispatchReceiver:path:userId:onSignRequested:onProgress:suspendHandler:)")));
+ (void)Skie_Suspend__127__signNostrEventDispatchReceiver:(id<PrimalSharedNostrEventSignatureHandler>)dispatchReceiver unsignedNostrEvent:(PrimalSharedNostrUnsignedEvent *)unsignedNostrEvent suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__127__signNostrEvent(dispatchReceiver:unsignedNostrEvent:suspendHandler:)")));
+ (void)Skie_Suspend__128__publishNostrEventDispatchReceiver:(id<PrimalSharedNostrEventPublisher>)dispatchReceiver nostrEvent:(PrimalSharedNostrEvent *)nostrEvent outboxRelays:(NSArray<NSString *> *)outboxRelays suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__128__publishNostrEvent(dispatchReceiver:nostrEvent:outboxRelays:suspendHandler:)")));
+ (void)Skie_Suspend__129__createOrNullDispatchReceiver:(id<PrimalSharedNostrZapperFactory>)dispatchReceiver userId:(NSString *)userId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__129__createOrNull(dispatchReceiver:userId:suspendHandler:)")));
...
+ (void)Skie_Suspend__130__hasNextDispatchReceiver:(PrimalSharedSkieColdFlowIterator<id> *)dispatchReceiver suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__130__hasNext(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__131__upgradeDispatchReceiver:(PrimalSharedKtor_httpOutgoingContentProtocolUpgrade *)dispatchReceiver input:(id<PrimalSharedKtor_ioByteReadChannel>)input output:(id<PrimalSharedKtor_ioByteWriteChannel>)output engineContext:(id<PrimalSharedKotlinCoroutineContext>)engineContext userContext:(id<PrimalSharedKotlinCoroutineContext>)userContext suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__131__upgrade(dispatchReceiver:input:output:engineContext:userContext:suspendHandler:)")));
+ (void)Skie_Suspend__132__flushDispatchReceiver:(id<PrimalSharedKtor_ioByteWriteChannel>)dispatchReceiver suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__132__flush(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__133__flushAndCloseDispatchReceiver:(id<PrimalSharedKtor_ioByteWriteChannel>)dispatchReceiver suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__133__flushAndClose(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__134__writeToDispatchReceiver:(PrimalSharedKtor_httpOutgoingContentWriteChannelContent *)dispatchReceiver channel:(id<PrimalSharedKtor_ioByteWriteChannel>)channel suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__134__writeTo(dispatchReceiver:channel:suspendHandler:)")));
...
+ (void)Skie_Suspend__46__fetchPopularUsersDispatchReceiver:(id<PrimalSharedExploreRepository>)dispatchReceiver suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__46__fetchPopularUsers(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__47__fetchTrendingPeopleDispatchReceiver:(id<PrimalSharedExploreRepository>)dispatchReceiver userId:(NSString *)userId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__47__fetchTrendingPeople(dispatchReceiver:userId:suspendHandler:)")));
+ (void)Skie_Suspend__48__fetchTrendingTopicsDispatchReceiver:(id<PrimalSharedExploreRepository>)dispatchReceiver suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__48__fetchTrendingTopics(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__49__fetchTrendingZapsDispatchReceiver:(id<PrimalSharedExploreRepository>)dispatchReceiver userId:(NSString *)userId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__49__fetchTrendingZaps(dispatchReceiver:userId:suspendHandler:)")));
...
+ (void)Skie_Suspend__50__searchUsersDispatchReceiver:(id<PrimalSharedExploreRepository>)dispatchReceiver query:(NSString *)query limit:(int32_t)limit suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__50__searchUsers(dispatchReceiver:query:limit:suspendHandler:)")));
+ (void)Skie_Suspend__51__addDvmFeedLocallyDispatchReceiver:(id<PrimalSharedFeedsRepository>)dispatchReceiver userId:(NSString *)userId dvmFeed:(PrimalSharedDvmFeed *)dvmFeed specKind:(PrimalSharedFeedSpecKind *)specKind suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__51__addDvmFeedLocally(dispatchReceiver:userId:dvmFeed:specKind:suspendHandler:)")));
+ (void)Skie_Suspend__52__addFeedLocallyDispatchReceiver:(id<PrimalSharedFeedsRepository>)dispatchReceiver userId:(NSString *)userId feedSpec:(NSString *)feedSpec title:(NSString *)title description:(NSString *)description feedSpecKind:(PrimalSharedFeedSpecKind *)feedSpecKind feedKind:(NSString *)feedKind suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__52__addFeedLocally(dispatchReceiver:userId:feedSpec:title:description:feedSpecKind:feedKind:suspendHandler:)")));
+ (void)Skie_Suspend__53__fetchAndPersistArticleFeedsDispatchReceiver:(id<PrimalSharedFeedsRepository>)dispatchReceiver userId:(NSString *)userId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__53__fetchAndPersistArticleFeeds(dispatchReceiver:userId:suspendHandler:)")));
+ (void)Skie_Suspend__54__fetchAndPersistDefaultFeedsDispatchReceiver:(id<PrimalSharedFeedsRepository>)dispatchReceiver userId:(NSString *)userId specKind:(PrimalSharedFeedSpecKind *)specKind givenDefaultFeeds:(NSArray<PrimalSharedPrimalFeed *> *)givenDefaultFeeds suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__54__fetchAndPersistDefaultFeeds(dispatchReceiver:userId:specKind:givenDefaultFeeds:suspendHandler:)")));
+ (void)Skie_Suspend__55__fetchAndPersistNoteFeedsDispatchReceiver:(id<PrimalSharedFeedsRepository>)dispatchReceiver userId:(NSString *)userId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__55__fetchAndPersistNoteFeeds(dispatchReceiver:userId:suspendHandler:)")));
+ (void)Skie_Suspend__56__fetchDefaultFeedsDispatchReceiver:(id<PrimalSharedFeedsRepository>)dispatchReceiver userId:(NSString *)userId specKind:(PrimalSharedFeedSpecKind *)specKind suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__56__fetchDefaultFeeds(dispatchReceiver:userId:specKind:suspendHandler:)")));
+ (void)Skie_Suspend__57__fetchRecommendedDvmFeedsDispatchReceiver:(id<PrimalSharedFeedsRepository>)dispatchReceiver userId:(NSString *)userId specKind:(PrimalSharedFeedSpecKind * _Nullable)specKind suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__57__fetchRecommendedDvmFeeds(dispatchReceiver:userId:specKind:suspendHandler:)")));
+ (void)Skie_Suspend__58__persistLocallyAndRemotelyUserFeedsDispatchReceiver:(id<PrimalSharedFeedsRepository>)dispatchReceiver userId:(NSString *)userId specKind:(PrimalSharedFeedSpecKind *)specKind feeds:(NSArray<PrimalSharedPrimalFeed *> *)feeds suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__58__persistLocallyAndRemotelyUserFeeds(dispatchReceiver:userId:specKind:feeds:suspendHandler:)")));
+ (void)Skie_Suspend__59__persistNewDefaultFeedsDispatchReceiver:(id<PrimalSharedFeedsRepository>)dispatchReceiver userId:(NSString *)userId specKind:(PrimalSharedFeedSpecKind *)specKind givenDefaultFeeds:(NSArray<PrimalSharedPrimalFeed *> *)givenDefaultFeeds suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__59__persistNewDefaultFeeds(dispatchReceiver:userId:specKind:givenDefaultFeeds:suspendHandler:)")));
...
+ (void)Skie_Suspend__60__persistRemotelyAllLocalUserFeedsDispatchReceiver:(id<PrimalSharedFeedsRepository>)dispatchReceiver userId:(NSString *)userId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__60__persistRemotelyAllLocalUserFeeds(dispatchReceiver:userId:suspendHandler:)")));
+ (void)Skie_Suspend__61__removeFeedLocallyDispatchReceiver:(id<PrimalSharedFeedsRepository>)dispatchReceiver userId:(NSString *)userId feedSpec:(NSString *)feedSpec suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__61__removeFeedLocally(dispatchReceiver:userId:feedSpec:suspendHandler:)")));
+ (void)Skie_Suspend__62__cacheEventsDispatchReceiver:(id<PrimalSharedCachingImportRepository>)dispatchReceiver nostrEvents:(NSArray<PrimalSharedNostrEvent *> *)nostrEvents primalEvents:(NSArray<PrimalSharedPrimalEvent *> *)primalEvents suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__62__cacheEvents(dispatchReceiver:nostrEvents:primalEvents:suspendHandler:)")));
+ (void)Skie_Suspend__63__cacheNostrEventsDispatchReceiver:(id<PrimalSharedCachingImportRepository>)dispatchReceiver events:(PrimalSharedKotlinArray<PrimalSharedNostrEvent *> *)events suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__63__cacheNostrEvents(dispatchReceiver:events:suspendHandler:)")));
+ (void)Skie_Suspend__64__cacheNostrEventsDispatchReceiver:(id<PrimalSharedCachingImportRepository>)dispatchReceiver events:(NSArray<PrimalSharedNostrEvent *> *)events suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__64__cacheNostrEvents(dispatchReceiver:events:suspendHandler:)")));
+ (void)Skie_Suspend__65__cachePrimalEventsDispatchReceiver:(id<PrimalSharedCachingImportRepository>)dispatchReceiver events:(PrimalSharedKotlinArray<PrimalSharedPrimalEvent *> *)events suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__65__cachePrimalEvents(dispatchReceiver:events:suspendHandler:)")));
+ (void)Skie_Suspend__66__cachePrimalEventsDispatchReceiver:(id<PrimalSharedCachingImportRepository>)dispatchReceiver events:(NSArray<PrimalSharedPrimalEvent *> *)events suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__66__cachePrimalEvents(dispatchReceiver:events:suspendHandler:)")));
+ (void)Skie_Suspend__67__loadEventLinksDispatchReceiver:(id<PrimalSharedEventUriRepository>)dispatchReceiver noteId:(NSString *)noteId types:(NSArray<PrimalSharedEventUriType *> *)types suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__67__loadEventLinks(dispatchReceiver:noteId:types:suspendHandler:)")));
+ (void)Skie_Suspend__68__fetchFollowConversationsDispatchReceiver:(id<PrimalSharedChatRepository>)dispatchReceiver userId:(NSString *)userId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__68__fetchFollowConversations(dispatchReceiver:userId:suspendHandler:)")));
+ (void)Skie_Suspend__69__fetchNewConversationMessagesDispatchReceiver:(id<PrimalSharedChatRepository>)dispatchReceiver userId:(NSString *)userId conversationUserId:(NSString *)conversationUserId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__69__fetchNewConversationMessages(dispatchReceiver:userId:conversationUserId:suspendHandler:)")));
...
+ (void)Skie_Suspend__70__fetchNonFollowsConversationsDispatchReceiver:(id<PrimalSharedChatRepository>)dispatchReceiver userId:(NSString *)userId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__70__fetchNonFollowsConversations(dispatchReceiver:userId:suspendHandler:)")));
+ (void)Skie_Suspend__71__markAllMessagesAsReadDispatchReceiver:(id<PrimalSharedChatRepository>)dispatchReceiver authorization:(PrimalSharedNostrEvent *)authorization suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__71__markAllMessagesAsRead(dispatchReceiver:authorization:suspendHandler:)")));
+ (void)Skie_Suspend__72__markConversationAsReadDispatchReceiver:(id<PrimalSharedChatRepository>)dispatchReceiver authorization:(PrimalSharedNostrEvent *)authorization conversationUserId:(NSString *)conversationUserId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__72__markConversationAsRead(dispatchReceiver:authorization:conversationUserId:suspendHandler:)")));
+ (void)Skie_Suspend__73__sendMessageDispatchReceiver:(id<PrimalSharedChatRepository>)dispatchReceiver userId:(NSString *)userId receiverId:(NSString *)receiverId text:(NSString *)text suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__73__sendMessage(dispatchReceiver:userId:receiverId:text:suspendHandler:)")));
+ (void)Skie_Suspend__74__fetchAndPersistMuteListDispatchReceiver:(id<PrimalSharedMutedItemRepository>)dispatchReceiver userId:(NSString *)userId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__74__fetchAndPersistMuteList(dispatchReceiver:userId:suspendHandler:)")));
+ (void)Skie_Suspend__75__muteHashtagAndPersistMuteListDispatchReceiver:(id<PrimalSharedMutedItemRepository>)dispatchReceiver userId:(NSString *)userId hashtag:(NSString *)hashtag suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__75__muteHashtagAndPersistMuteList(dispatchReceiver:userId:hashtag:suspendHandler:)")));
+ (void)Skie_Suspend__76__muteThreadAndPersistMuteListDispatchReceiver:(id<PrimalSharedMutedItemRepository>)dispatchReceiver userId:(NSString *)userId postId:(NSString *)postId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__76__muteThreadAndPersistMuteList(dispatchReceiver:userId:postId:suspendHandler:)")));
+ (void)Skie_Suspend__77__muteUserAndPersistMuteListDispatchReceiver:(id<PrimalSharedMutedItemRepository>)dispatchReceiver userId:(NSString *)userId mutedUserId:(NSString *)mutedUserId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__77__muteUserAndPersistMuteList(dispatchReceiver:userId:mutedUserId:suspendHandler:)")));
+ (void)Skie_Suspend__78__muteWordAndPersistMuteListDispatchReceiver:(id<PrimalSharedMutedItemRepository>)dispatchReceiver userId:(NSString *)userId word:(NSString *)word suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__78__muteWordAndPersistMuteList(dispatchReceiver:userId:word:suspendHandler:)")));
+ (void)Skie_Suspend__79__unmuteHashtagAndPersistMuteListDispatchReceiver:(id<PrimalSharedMutedItemRepository>)dispatchReceiver userId:(NSString *)userId hashtag:(NSString *)hashtag suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__79__unmuteHashtagAndPersistMuteList(dispatchReceiver:userId:hashtag:suspendHandler:)")));
...
+ (void)Skie_Suspend__80__unmuteThreadAndPersistMuteListDispatchReceiver:(id<PrimalSharedMutedItemRepository>)dispatchReceiver userId:(NSString *)userId postId:(NSString *)postId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__80__unmuteThreadAndPersistMuteList(dispatchReceiver:userId:postId:suspendHandler:)")));
+ (void)Skie_Suspend__81__unmuteUserAndPersistMuteListDispatchReceiver:(id<PrimalSharedMutedItemRepository>)dispatchReceiver userId:(NSString *)userId unmutedUserId:(NSString *)unmutedUserId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__81__unmuteUserAndPersistMuteList(dispatchReceiver:userId:unmutedUserId:suspendHandler:)")));
+ (void)Skie_Suspend__82__unmuteWordAndPersistMuteListDispatchReceiver:(id<PrimalSharedMutedItemRepository>)dispatchReceiver userId:(NSString *)userId word:(NSString *)word suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__82__unmuteWordAndPersistMuteList(dispatchReceiver:userId:word:suspendHandler:)")));
+ (void)Skie_Suspend__83__markAllNotificationsAsSeenDispatchReceiver:(id<PrimalSharedNotificationRepository>)dispatchReceiver authorization:(PrimalSharedNostrEvent *)authorization suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__83__markAllNotificationsAsSeen(dispatchReceiver:authorization:suspendHandler:)")));
+ (void)Skie_Suspend__84__deletePostByIdDispatchReceiver:(id<PrimalSharedFeedRepository>)dispatchReceiver postId:(NSString *)postId userId:(NSString *)userId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__84__deletePostById(dispatchReceiver:postId:userId:suspendHandler:)")));
+ (void)Skie_Suspend__85__fetchConversationDispatchReceiver:(id<PrimalSharedFeedRepository>)dispatchReceiver userId:(NSString *)userId noteId:(NSString *)noteId limit:(int32_t)limit suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__85__fetchConversation(dispatchReceiver:userId:noteId:limit:suspendHandler:)")));
+ (void)Skie_Suspend__86__fetchFeedPageSnapshotDispatchReceiver:(id<PrimalSharedFeedRepository>)dispatchReceiver userId:(NSString *)userId feedSpec:(NSString *)feedSpec notes:(NSString * _Nullable)notes until:(PrimalSharedLong * _Nullable)until since:(PrimalSharedLong * _Nullable)since order:(NSString * _Nullable)order limit:(int32_t)limit suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__86__fetchFeedPageSnapshot(dispatchReceiver:userId:feedSpec:notes:until:since:order:limit:suspendHandler:)")));
+ (void)Skie_Suspend__87__fetchRepliesDispatchReceiver:(id<PrimalSharedFeedRepository>)dispatchReceiver userId:(NSString *)userId noteId:(NSString *)noteId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__87__fetchReplies(dispatchReceiver:userId:noteId:suspendHandler:)")));
+ (void)Skie_Suspend__88__findAllPostsByIdsDispatchReceiver:(id<PrimalSharedFeedRepository>)dispatchReceiver postIds:(NSArray<NSString *> *)postIds suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__88__findAllPostsByIds(dispatchReceiver:postIds:suspendHandler:)")));
+ (void)Skie_Suspend__89__findConversationDispatchReceiver:(id<PrimalSharedFeedRepository>)dispatchReceiver userId:(NSString *)userId noteId:(NSString *)noteId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__89__findConversation(dispatchReceiver:userId:noteId:suspendHandler:)")));
...
+ (void)Skie_Suspend__90__findNewestPostsDispatchReceiver:(id<PrimalSharedFeedRepository>)dispatchReceiver userId:(NSString *)userId feedDirective:(NSString *)feedDirective allowMutedThreads:(BOOL)allowMutedThreads limit:(int32_t)limit suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__90__findNewestPosts(dispatchReceiver:userId:feedDirective:allowMutedThreads:limit:suspendHandler:)")));
+ (void)Skie_Suspend__91__findPostsByIdDispatchReceiver:(id<PrimalSharedFeedRepository>)dispatchReceiver postId:(NSString *)postId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__91__findPostsById(dispatchReceiver:postId:suspendHandler:)")));
+ (void)Skie_Suspend__92__removeFeedSpecDispatchReceiver:(id<PrimalSharedFeedRepository>)dispatchReceiver userId:(NSString *)userId feedSpec:(NSString *)feedSpec suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__92__removeFeedSpec(dispatchReceiver:userId:feedSpec:suspendHandler:)")));
+ (void)Skie_Suspend__93__replaceFeedDispatchReceiver:(id<PrimalSharedFeedRepository>)dispatchReceiver userId:(NSString *)userId feedSpec:(NSString *)feedSpec snapshot:(PrimalSharedFeedPageSnapshot *)snapshot suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__93__replaceFeed(dispatchReceiver:userId:feedSpec:snapshot:suspendHandler:)")));
+ (void)Skie_Suspend__94__fetchFollowersDispatchReceiver:(id<PrimalSharedProfileRepository>)dispatchReceiver profileId:(NSString *)profileId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__94__fetchFollowers(dispatchReceiver:profileId:suspendHandler:)")));
+ (void)Skie_Suspend__95__fetchFollowingDispatchReceiver:(id<PrimalSharedProfileRepository>)dispatchReceiver profileId:(NSString *)profileId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__95__fetchFollowing(dispatchReceiver:profileId:suspendHandler:)")));
+ (void)Skie_Suspend__96__fetchProfileDispatchReceiver:(id<PrimalSharedProfileRepository>)dispatchReceiver profileId:(NSString *)profileId suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__96__fetchProfile(dispatchReceiver:profileId:suspendHandler:)")));
+ (void)Skie_Suspend__97__fetchProfileIdDispatchReceiver:(id<PrimalSharedProfileRepository>)dispatchReceiver primalName:(NSString *)primalName suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__97__fetchProfileId(dispatchReceiver:primalName:suspendHandler:)")));
+ (void)Skie_Suspend__98__fetchProfilesDispatchReceiver:(id<PrimalSharedProfileRepository>)dispatchReceiver profileIds:(NSArray<NSString *> *)profileIds suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__98__fetchProfiles(dispatchReceiver:profileIds:suspendHandler:)")));
+ (void)Skie_Suspend__99__fetchUserProfileFollowedByDispatchReceiver:(id<PrimalSharedProfileRepository>)dispatchReceiver profileId:(NSString *)profileId userId:(NSString *)userId limit:(int32_t)limit suspendHandler:(PrimalSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__99__fetchUserProfileFollowedBy(dispatchReceiver:profileId:userId:limit:suspendHandler:)")));
