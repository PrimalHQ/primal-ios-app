...
typedef id<PrimalSharedKotlinx_coroutines_coreJob> _Nonnull Skie__TypeDef__0__id_PrimalSharedKotlinx_coroutines_coreJob_ __attribute__((__swift_private__));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("IosRepositoryFactory")))
@interface PrimalSharedIosRepositoryFactory : PrimalSharedBase
@property (class, readonly, getter=shared) PrimalSharedIosRepositoryFactory *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)iosRepositoryFactory __attribute__((swift_name("init()")));
- (id<PrimalSharedFeedRepository>)createFeedRepository __attribute__((swift_name("createFeedRepository()")));
@end
...
- (instancetype)initWithDescription:(NSString * _Nullable)description notifications:(NSDictionary<NSString *, PrimalSharedKotlinx_serialization_jsonJsonElement *> *)notifications defaultZapAmount:(PrimalSharedULong * _Nullable)defaultZapAmount zapOptions:(NSArray<PrimalSharedULong *> *)zapOptions zapDefault:(PrimalSharedContentZapDefault * _Nullable)zapDefault zapsConfig:(NSArray<PrimalSharedContentZapConfigItem *> *)zapsConfig __attribute__((swift_name("init(description:notifications:defaultZapAmount:zapOptions:zapDefault:zapsConfig:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedContentAppSettings *)doCopyDescription:(NSString * _Nullable)description notifications:(NSDictionary<NSString *, PrimalSharedKotlinx_serialization_jsonJsonElement *> *)notifications defaultZapAmount:(PrimalSharedULong * _Nullable)defaultZapAmount zapOptions:(NSArray<PrimalSharedULong *> *)zapOptions zapDefault:(PrimalSharedContentZapDefault * _Nullable)zapDefault zapsConfig:(NSArray<PrimalSharedContentZapConfigItem *> *)zapsConfig __attribute__((swift_name("doCopy(description:notifications:defaultZapAmount:zapOptions:zapDefault:zapsConfig:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithEventId:(NSString *)eventId author:(PrimalSharedFeedPostAuthor *)author content:(NSString *)content timestamp:(PrimalSharedKotlinx_datetimeInstant *)timestamp rawNostrEvent:(NSString *)rawNostrEvent hashtags:(NSArray<NSString *> *)hashtags replyToAuthor:(PrimalSharedFeedPostAuthor * _Nullable)replyToAuthor reposts:(NSArray<PrimalSharedFeedPostRepostInfo *> *)reposts stats:(PrimalSharedFeedPostStats * _Nullable)stats links:(NSArray<PrimalSharedEventLink *> *)links nostrUris:(NSArray<PrimalSharedEventUriNostrReference *> *)nostrUris eventZaps:(NSArray<PrimalSharedEventZap *> *)eventZaps __attribute__((swift_name("init(eventId:author:content:timestamp:rawNostrEvent:hashtags:replyToAuthor:reposts:stats:links:nostrUris:eventZaps:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedFeedPost *)doCopyEventId:(NSString *)eventId author:(PrimalSharedFeedPostAuthor *)author content:(NSString *)content timestamp:(PrimalSharedKotlinx_datetimeInstant *)timestamp rawNostrEvent:(NSString *)rawNostrEvent hashtags:(NSArray<NSString *> *)hashtags replyToAuthor:(PrimalSharedFeedPostAuthor * _Nullable)replyToAuthor reposts:(NSArray<PrimalSharedFeedPostRepostInfo *> *)reposts stats:(PrimalSharedFeedPostStats * _Nullable)stats links:(NSArray<PrimalSharedEventLink *> *)links nostrUris:(NSArray<PrimalSharedEventUriNostrReference *> *)nostrUris eventZaps:(NSArray<PrimalSharedEventZap *> *)eventZaps __attribute__((swift_name("doCopy(eventId:author:content:timestamp:rawNostrEvent:hashtags:replyToAuthor:reposts:stats:links:nostrUris:eventZaps:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
- (instancetype)initWithRepostId:(NSString *)repostId repostAuthorId:(NSString * _Nullable)repostAuthorId repostAuthorDisplayName:(NSString * _Nullable)repostAuthorDisplayName __attribute__((swift_name("init(repostId:repostAuthorId:repostAuthorDisplayName:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedFeedPostRepostInfo *)doCopyRepostId:(NSString *)repostId repostAuthorId:(NSString * _Nullable)repostAuthorId repostAuthorDisplayName:(NSString * _Nullable)repostAuthorDisplayName __attribute__((swift_name("doCopy(repostId:repostAuthorId:repostAuthorDisplayName:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
@property (readonly) NSString *metadataEventId __attribute__((swift_name("metadataEventId")));
@property (readonly) NSString *metadataRawEvent __attribute__((swift_name("metadataRawEvent")));
@property (readonly) NSString * _Nullable primalName __attribute__((swift_name("primalName")));
...
@property (class, readonly) PrimalSharedNostrEventKind *walletrequest __attribute__((swift_name("walletrequest")));
@property (class, readonly) PrimalSharedNostrEventKind *walletresponse __attribute__((swift_name("walletresponse")));
...
@required
- (PrimalSharedNostrEvent *)signNostrEventUnsignedNostrEvent:(PrimalSharedNostrUnsignedEvent *)unsignedNostrEvent __attribute__((swift_name("signNostrEvent(unsignedNostrEvent:)")));
...
@required
- (void)publishNostrEventUserId:(NSString *)userId nostrEvent:(PrimalSharedNostrEvent *)nostrEvent outboxRelays:(NSArray<NSString *> *)outboxRelays __attribute__((swift_name("publishNostrEvent(userId:nostrEvent:outboxRelays:)")));
@end
...
@protocol PrimalSharedMutedUserRepository
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)fetchProfileProfileId:(NSString *)profileId completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("fetchProfile(profileId:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)findProfileDataProfileIds:(NSArray<NSString *> *)profileIds completionHandler:(void (^)(NSArray<NSArray<PrimalSharedProfileData *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("findProfileData(profileIds:completionHandler:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UploadJob")))
@interface PrimalSharedUploadJob : PrimalSharedBase
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) id<PrimalSharedKotlinx_coroutines_coreJob> job __attribute__((swift_name("job")));
- (instancetype)initWithJob:(id<PrimalSharedKotlinx_coroutines_coreJob>)job id:(NSString *)id __attribute__((swift_name("init(job:id:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedUploadJob *)doCopyJob:(id<PrimalSharedKotlinx_coroutines_coreJob>)job id:(NSString *)id __attribute__((swift_name("doCopy(job:id:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
@property (readonly) int32_t originalFileSize __attribute__((swift_name("originalFileSize")));
...
- (instancetype)initWithRemoteUrl:(NSString *)remoteUrl originalFileSize:(int32_t)originalFileSize originalHash:(NSString *)originalHash __attribute__((swift_name("init(remoteUrl:originalFileSize:originalHash:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedUploadResult *)doCopyRemoteUrl:(NSString *)remoteUrl originalFileSize:(int32_t)originalFileSize originalHash:(NSString *)originalHash __attribute__((swift_name("doCopy(remoteUrl:originalFileSize:originalHash:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
@interface PrimalSharedUploadStatus : PrimalSharedBase
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UploadStatus.UploadCompleted")))
@interface PrimalSharedUploadStatusUploadCompleted : PrimalSharedUploadStatus
@property (class, readonly, getter=shared) PrimalSharedUploadStatusUploadCompleted *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)uploadCompleted __attribute__((swift_name("init()")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UploadStatus.UploadFailed")))
@interface PrimalSharedUploadStatusUploadFailed : PrimalSharedUploadStatus
@property (class, readonly, getter=shared) PrimalSharedUploadStatusUploadFailed *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UploadStatus.Uploading")))
@interface PrimalSharedUploadStatusUploading : PrimalSharedUploadStatus
@property (class, readonly, getter=shared) PrimalSharedUploadStatusUploading *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Local_cachingEventZap")))
@interface PrimalSharedLocal_cachingEventZap : PrimalSharedBase
@property (readonly) double amountInBtc __attribute__((swift_name("amountInBtc")));
@property (readonly) NSString *eventId __attribute__((swift_name("eventId")));
@property (readonly) NSString * _Nullable message __attribute__((swift_name("message")));
@property (readonly) int64_t zapReceiptAt __attribute__((swift_name("zapReceiptAt")));
@property (readonly) NSString *zapReceiverId __attribute__((swift_name("zapReceiverId")));
@property (readonly) int64_t zapRequestAt __attribute__((swift_name("zapRequestAt")));
@property (readonly) PrimalSharedCdnImage * _Nullable zapSenderAvatarCdnImage __attribute__((swift_name("zapSenderAvatarCdnImage")));
@property (readonly) NSString * _Nullable zapSenderDisplayName __attribute__((swift_name("zapSenderDisplayName")));
@property (readonly) NSString * _Nullable zapSenderHandle __attribute__((swift_name("zapSenderHandle")));
@property (readonly) NSString *zapSenderId __attribute__((swift_name("zapSenderId")));
@property (readonly) NSString * _Nullable zapSenderInternetIdentifier __attribute__((swift_name("zapSenderInternetIdentifier")));
@property (readonly) PrimalSharedPrimalLegendProfile * _Nullable zapSenderPrimalLegendProfile __attribute__((swift_name("zapSenderPrimalLegendProfile")));
- (instancetype)initWithEventId:(NSString *)eventId zapSenderId:(NSString *)zapSenderId zapReceiverId:(NSString *)zapReceiverId zapRequestAt:(int64_t)zapRequestAt zapReceiptAt:(int64_t)zapReceiptAt amountInBtc:(double)amountInBtc message:(NSString * _Nullable)message zapSenderDisplayName:(NSString * _Nullable)zapSenderDisplayName zapSenderHandle:(NSString * _Nullable)zapSenderHandle zapSenderInternetIdentifier:(NSString * _Nullable)zapSenderInternetIdentifier zapSenderAvatarCdnImage:(PrimalSharedCdnImage * _Nullable)zapSenderAvatarCdnImage zapSenderPrimalLegendProfile:(PrimalSharedPrimalLegendProfile * _Nullable)zapSenderPrimalLegendProfile __attribute__((swift_name("init(eventId:zapSenderId:zapReceiverId:zapRequestAt:zapReceiptAt:amountInBtc:message:zapSenderDisplayName:zapSenderHandle:zapSenderInternetIdentifier:zapSenderAvatarCdnImage:zapSenderPrimalLegendProfile:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedLocal_cachingEventZap *)doCopyEventId:(NSString *)eventId zapSenderId:(NSString *)zapSenderId zapReceiverId:(NSString *)zapReceiverId zapRequestAt:(int64_t)zapRequestAt zapReceiptAt:(int64_t)zapReceiptAt amountInBtc:(double)amountInBtc message:(NSString * _Nullable)message zapSenderDisplayName:(NSString * _Nullable)zapSenderDisplayName zapSenderHandle:(NSString * _Nullable)zapSenderHandle zapSenderInternetIdentifier:(NSString * _Nullable)zapSenderInternetIdentifier zapSenderAvatarCdnImage:(PrimalSharedCdnImage * _Nullable)zapSenderAvatarCdnImage zapSenderPrimalLegendProfile:(PrimalSharedPrimalLegendProfile * _Nullable)zapSenderPrimalLegendProfile __attribute__((swift_name("doCopy(eventId:zapSenderId:zapReceiverId:zapRequestAt:zapReceiptAt:amountInBtc:message:zapSenderDisplayName:zapSenderHandle:zapSenderInternetIdentifier:zapSenderAvatarCdnImage:zapSenderPrimalLegendProfile:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end

@interface PrimalSharedLocal_cachingEventZap (Extensions)
- (NSString *)authorNameUiFriendly __attribute__((swift_name("authorNameUiFriendly()")));
- (NSString *)usernameUiFriendly __attribute__((swift_name("usernameUiFriendly()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Local_cachingPostData")))
@interface PrimalSharedLocal_cachingPostData : PrimalSharedBase
@property (readonly) NSString *authorId __attribute__((swift_name("authorId")));
...
@property (readonly) NSString *postId __attribute__((swift_name("postId")));
@property (readonly) NSString *raw __attribute__((swift_name("raw")));
@property (readonly) NSString * _Nullable replyToAuthorId __attribute__((swift_name("replyToAuthorId")));
@property (readonly) NSString * _Nullable replyToPostId __attribute__((swift_name("replyToPostId")));
@property (readonly) NSString *sig __attribute__((swift_name("sig")));
@property (readonly) NSArray<NSArray<PrimalSharedKotlinx_serialization_jsonJsonElement *> *> *tags __attribute__((swift_name("tags")));
@property (readonly) NSArray<NSString *> *uris __attribute__((swift_name("uris")));
- (instancetype)initWithPostId:(NSString *)postId authorId:(NSString *)authorId createdAt:(int64_t)createdAt tags:(NSArray<NSArray<PrimalSharedKotlinx_serialization_jsonJsonElement *> *> *)tags content:(NSString *)content uris:(NSArray<NSString *> *)uris hashtags:(NSArray<NSString *> *)hashtags sig:(NSString *)sig raw:(NSString *)raw authorMetadataId:(NSString * _Nullable)authorMetadataId replyToPostId:(NSString * _Nullable)replyToPostId replyToAuthorId:(NSString * _Nullable)replyToAuthorId __attribute__((swift_name("init(postId:authorId:createdAt:tags:content:uris:hashtags:sig:raw:authorMetadataId:replyToPostId:replyToAuthorId:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedLocal_cachingPostData *)doCopyPostId:(NSString *)postId authorId:(NSString *)authorId createdAt:(int64_t)createdAt tags:(NSArray<NSArray<PrimalSharedKotlinx_serialization_jsonJsonElement *> *> *)tags content:(NSString *)content uris:(NSArray<NSString *> *)uris hashtags:(NSArray<NSString *> *)hashtags sig:(NSString *)sig raw:(NSString *)raw authorMetadataId:(NSString * _Nullable)authorMetadataId replyToPostId:(NSString * _Nullable)replyToPostId replyToAuthorId:(NSString * _Nullable)replyToAuthorId __attribute__((swift_name("doCopy(postId:authorId:createdAt:tags:content:uris:hashtags:sig:raw:authorMetadataId:replyToPostId:replyToAuthorId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end

@interface PrimalSharedLocal_cachingPostData (Extensions)
- (PrimalSharedNevent *)toNevent __attribute__((swift_name("toNevent()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Local_cachingProfileData")))
@interface PrimalSharedLocal_cachingProfileData : PrimalSharedBase
@property (readonly) NSString * _Nullable about __attribute__((swift_name("about")));
@property (readonly) NSArray<NSString *> *aboutHashtags __attribute__((swift_name("aboutHashtags")));
@property (readonly) NSArray<NSString *> *aboutUris __attribute__((swift_name("aboutUris")));
@property (readonly) PrimalSharedCdnImage * _Nullable avatarCdnImage __attribute__((swift_name("avatarCdnImage")));
...
@property (readonly) NSString *raw __attribute__((swift_name("raw")));
@property (readonly) NSString * _Nullable website __attribute__((swift_name("website")));
- (instancetype)initWithOwnerId:(NSString *)ownerId eventId:(NSString *)eventId createdAt:(int64_t)createdAt raw:(NSString *)raw handle:(NSString * _Nullable)handle displayName:(NSString * _Nullable)displayName internetIdentifier:(NSString * _Nullable)internetIdentifier lightningAddress:(NSString * _Nullable)lightningAddress lnUrlDecoded:(NSString * _Nullable)lnUrlDecoded avatarCdnImage:(PrimalSharedCdnImage * _Nullable)avatarCdnImage bannerCdnImage:(PrimalSharedCdnImage * _Nullable)bannerCdnImage website:(NSString * _Nullable)website about:(NSString * _Nullable)about aboutUris:(NSArray<NSString *> *)aboutUris aboutHashtags:(NSArray<NSString *> *)aboutHashtags primalName:(NSString * _Nullable)primalName primalPremiumInfo:(PrimalSharedPrimalPremiumInfo * _Nullable)primalPremiumInfo blossoms:(NSArray<NSString *> *)blossoms __attribute__((swift_name("init(ownerId:eventId:createdAt:raw:handle:displayName:internetIdentifier:lightningAddress:lnUrlDecoded:avatarCdnImage:bannerCdnImage:website:about:aboutUris:aboutHashtags:primalName:primalPremiumInfo:blossoms:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedLocal_cachingProfileData *)doCopyOwnerId:(NSString *)ownerId eventId:(NSString *)eventId createdAt:(int64_t)createdAt raw:(NSString *)raw handle:(NSString * _Nullable)handle displayName:(NSString * _Nullable)displayName internetIdentifier:(NSString * _Nullable)internetIdentifier lightningAddress:(NSString * _Nullable)lightningAddress lnUrlDecoded:(NSString * _Nullable)lnUrlDecoded avatarCdnImage:(PrimalSharedCdnImage * _Nullable)avatarCdnImage bannerCdnImage:(PrimalSharedCdnImage * _Nullable)bannerCdnImage website:(NSString * _Nullable)website about:(NSString * _Nullable)about aboutUris:(NSArray<NSString *> *)aboutUris aboutHashtags:(NSArray<NSString *> *)aboutHashtags primalName:(NSString * _Nullable)primalName primalPremiumInfo:(PrimalSharedPrimalPremiumInfo * _Nullable)primalPremiumInfo blossoms:(NSArray<NSString *> *)blossoms __attribute__((swift_name("doCopy(ownerId:eventId:createdAt:raw:handle:displayName:internetIdentifier:lightningAddress:lnUrlDecoded:avatarCdnImage:bannerCdnImage:website:about:aboutUris:aboutHashtags:primalName:primalPremiumInfo:blossoms:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end

@interface PrimalSharedLocal_cachingProfileData (Extensions)
- (NSString *)authorNameUiFriendly __attribute__((swift_name("authorNameUiFriendly()")));
- (NSString *)usernameUiFriendly __attribute__((swift_name("usernameUiFriendly()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Remote_cachingContentPrimalEventStats")))
@interface PrimalSharedRemote_cachingContentPrimalEventStats : PrimalSharedBase
@property (class, readonly, getter=companion) PrimalSharedRemote_cachingContentPrimalEventStatsCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString *eventId __attribute__((swift_name("eventId")));
@property (readonly) int64_t likes __attribute__((swift_name("likes")));
@property (readonly) int64_t mentions __attribute__((swift_name("mentions")));
@property (readonly) int64_t replies __attribute__((swift_name("replies")));
@property (readonly) int64_t reposts __attribute__((swift_name("reposts")));
@property (readonly) int64_t satsZapped __attribute__((swift_name("satsZapped")));
@property (readonly) int64_t score __attribute__((swift_name("score")));
@property (readonly) int64_t score24h __attribute__((swift_name("score24h")));
@property (readonly) int64_t zaps __attribute__((swift_name("zaps")));
- (instancetype)initWithEventId:(NSString *)eventId likes:(int64_t)likes replies:(int64_t)replies mentions:(int64_t)mentions reposts:(int64_t)reposts zaps:(int64_t)zaps satsZapped:(int64_t)satsZapped score:(int64_t)score score24h:(int64_t)score24h __attribute__((swift_name("init(eventId:likes:replies:mentions:reposts:zaps:satsZapped:score:score24h:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedRemote_cachingContentPrimalEventStats *)doCopyEventId:(NSString *)eventId likes:(int64_t)likes replies:(int64_t)replies mentions:(int64_t)mentions reposts:(int64_t)reposts zaps:(int64_t)zaps satsZapped:(int64_t)satsZapped score:(int64_t)score score24h:(int64_t)score24h __attribute__((swift_name("doCopy(eventId:likes:replies:mentions:reposts:zaps:satsZapped:score:score24h:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="satszapped")
*/
@end

@interface PrimalSharedRemote_cachingContentPrimalEventStats (Extensions)
- (PrimalSharedLocal_cachingEventStats *)asEventStatsPO __attribute__((swift_name("asEventStatsPO()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Remote_cachingContentPrimalEventUserStats")))
@interface PrimalSharedRemote_cachingContentPrimalEventUserStats : PrimalSharedBase
@property (class, readonly, getter=companion) PrimalSharedRemote_cachingContentPrimalEventUserStatsCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString *eventId __attribute__((swift_name("eventId")));
@property (readonly) BOOL liked __attribute__((swift_name("liked")));
@property (readonly) BOOL replied __attribute__((swift_name("replied")));
@property (readonly) BOOL reposted __attribute__((swift_name("reposted")));
@property (readonly) BOOL zapped __attribute__((swift_name("zapped")));
- (instancetype)initWithEventId:(NSString *)eventId replied:(BOOL)replied liked:(BOOL)liked reposted:(BOOL)reposted zapped:(BOOL)zapped __attribute__((swift_name("init(eventId:replied:liked:reposted:zapped:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedRemote_cachingContentPrimalEventUserStats *)doCopyEventId:(NSString *)eventId replied:(BOOL)replied liked:(BOOL)liked reposted:(BOOL)reposted zapped:(BOOL)zapped __attribute__((swift_name("doCopy(eventId:replied:liked:reposted:zapped:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="replied")
*/

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="reposted")
*/

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="zapped")
*/
@end

@interface PrimalSharedRemote_cachingContentPrimalEventUserStats (Extensions)
- (PrimalSharedLocal_cachingEventUserStats *)asEventUserStatsPOUserId:(NSString *)userId __attribute__((swift_name("asEventUserStatsPO(userId:)")));
@end
...
- (PrimalSharedLocal_cachingProfileStats * _Nullable)asProfileStatsPO __attribute__((swift_name("asProfileStatsPO()")));
- (NSDictionary<NSString *, PrimalSharedPrimalLegendProfile *> *)parseAndMapPrimalLegendProfiles __attribute__((swift_name("parseAndMapPrimalLegendProfiles()")));
- (NSDictionary<NSString *, PrimalSharedRemote_cachingContentProfilePremiumInfo *> *)parseAndMapPrimalPremiumInfo __attribute__((swift_name("parseAndMapPrimalPremiumInfo()")));
- (NSDictionary<NSString *, NSString *> *)parseAndMapPrimalUserNames __attribute__((swift_name("parseAndMapPrimalUserNames()")));
- (NSDictionary<NSString *, PrimalSharedInt *> *)takeContentAsPrimalUserFollowersCountsOrNull __attribute__((swift_name("takeContentAsPrimalUserFollowersCountsOrNull()")));
- (NSDictionary<NSString *, PrimalSharedFloat *> *)takeContentAsPrimalUserScoresOrNull __attribute__((swift_name("takeContentAsPrimalUserScoresOrNull()")));
...
- (PrimalSharedLocal_cachingHighlightData *)asHighlightData __attribute__((swift_name("asHighlightData()")));
- (PrimalSharedLocal_cachingProfileData *)asProfileDataPOCdnResources:(NSDictionary<NSString *, PrimalSharedCdnResource *> *)cdnResources primalUserNames:(NSDictionary<NSString *, NSString *> *)primalUserNames primalPremiumInfo:(NSDictionary<NSString *, PrimalSharedRemote_cachingContentProfilePremiumInfo *> *)primalPremiumInfo primalLegendProfiles:(NSDictionary<NSString *, PrimalSharedPrimalLegendProfile *> *)primalLegendProfiles blossomServers:(NSDictionary<NSString *, NSArray<NSString *> *> *)blossomServers __attribute__((swift_name("asProfileDataPO(cdnResources:primalUserNames:primalPremiumInfo:primalLegendProfiles:blossomServers:)")));
- (PrimalSharedLocal_cachingRepostData *)asRepostDataPOPostId:(NSString *)postId postAuthorId:(NSString *)postAuthorId __attribute__((swift_name("asRepostDataPO(postId:postAuthorId:)")));
- (PrimalSharedNostrEvent * _Nullable)extractZapRequestOrNull __attribute__((swift_name("extractZapRequestOrNull()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
+ (NSString * _Nullable)bech32ToHexOrThrow:(NSString *)receiver error:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("bech32ToHexOrThrow(_:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EventUriParsersKt")))
@interface PrimalSharedEventUriParsersKt : PrimalSharedBase
+ (NSArray<PrimalSharedLocal_cachingEventUri *> *)flatMapArticlesAsEventUriPO:(NSArray<PrimalSharedLocal_cachingArticleData *> *)receiver cdnResources:(NSDictionary<NSString *, PrimalSharedCdnResource *> *)cdnResources linkPreviews:(NSDictionary<NSString *, PrimalSharedEventLinkPreviewData *> *)linkPreviews videoThumbnails:(NSDictionary<NSString *, NSString *> *)videoThumbnails __attribute__((swift_name("flatMapArticlesAsEventUriPO(_:cdnResources:linkPreviews:videoThumbnails:)")));
+ (NSArray<PrimalSharedLocal_cachingEventUri *> *)flatMapMessagesAsEventUriPO:(NSArray<PrimalSharedLocal_cachingDirectMessageData *> *)receiver __attribute__((swift_name("flatMapMessagesAsEventUriPO(_:)")));
+ (NSArray<PrimalSharedLocal_cachingEventUri *> *)flatMapPostsAsEventUriPO:(NSArray<PrimalSharedLocal_cachingPostData *> *)receiver cdnResources:(NSDictionary<NSString *, PrimalSharedCdnResource *> *)cdnResources linkPreviews:(NSDictionary<NSString *, PrimalSharedEventLinkPreviewData *> *)linkPreviews videoThumbnails:(NSDictionary<NSString *, NSString *> *)videoThumbnails __attribute__((swift_name("flatMapPostsAsEventUriPO(_:cdnResources:linkPreviews:videoThumbnails:)")));
+ (NSArray<PrimalSharedEventLink *> *)mapEventUriAsNoteLinkDO:(NSArray<PrimalSharedLocal_cachingEventUri *> *)receiver __attribute__((swift_name("mapEventUriAsNoteLinkDO(_:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HighlightEventsKt")))
@interface PrimalSharedHighlightEventsKt : PrimalSharedBase
+ (NSArray<PrimalSharedLocal_cachingHighlightData *> *)mapReferencedEventsAsHighlightDataPO:(NSArray<PrimalSharedPrimalEvent *> *)receiver __attribute__((swift_name("mapReferencedEventsAsHighlightDataPO(_:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LongFormContentEventsKt")))
@interface PrimalSharedLongFormContentEventsKt : PrimalSharedBase
+ (NSArray<PrimalSharedLocal_cachingArticleData *> *)mapNotNullAsArticleDataPO:(NSArray<PrimalSharedNostrEvent *> *)receiver wordsCountMap:(NSDictionary<NSString *, PrimalSharedInt *> *)wordsCountMap cdnResources:(NSDictionary<NSString *, PrimalSharedCdnResource *> *)cdnResources __attribute__((swift_name("mapNotNullAsArticleDataPO(_:wordsCountMap:cdnResources:)")));
+ (NSArray<PrimalSharedLocal_cachingArticleData *> *)mapReferencedEventsAsArticleDataPO:(NSArray<PrimalSharedPrimalEvent *> *)receiver wordsCountMap:(NSDictionary<NSString *, PrimalSharedInt *> *)wordsCountMap cdnResources:(NSDictionary<NSString *, PrimalSharedCdnResource *> *)cdnResources __attribute__((swift_name("mapReferencedEventsAsArticleDataPO(_:wordsCountMap:cdnResources:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MetadataEventsKt")))
@interface PrimalSharedMetadataEventsKt : PrimalSharedBase
+ (NSArray<PrimalSharedLocal_cachingProfileData *> *)mapAsProfileDataPO:(NSArray<PrimalSharedNostrEvent *> *)receiver cdnResources:(NSArray<PrimalSharedCdnResource *> *)cdnResources primalUserNames:(NSDictionary<NSString *, NSString *> *)primalUserNames primalPremiumInfo:(NSDictionary<NSString *, PrimalSharedRemote_cachingContentProfilePremiumInfo *> *)primalPremiumInfo primalLegendProfiles:(NSDictionary<NSString *, PrimalSharedPrimalLegendProfile *> *)primalLegendProfiles blossomServers:(NSDictionary<NSString *, NSArray<NSString *> *> *)blossomServers __attribute__((swift_name("mapAsProfileDataPO(_:cdnResources:primalUserNames:primalPremiumInfo:primalLegendProfiles:blossomServers:)")));
+ (NSArray<PrimalSharedLocal_cachingProfileData *> *)mapAsProfileDataPO:(NSArray<PrimalSharedNostrEvent *> *)receiver cdnResourcesMap:(NSDictionary<NSString *, PrimalSharedCdnResource *> *)cdnResourcesMap primalUserNames:(NSDictionary<NSString *, NSString *> *)primalUserNames primalPremiumInfo:(NSDictionary<NSString *, PrimalSharedRemote_cachingContentProfilePremiumInfo *> *)primalPremiumInfo primalLegendProfiles:(NSDictionary<NSString *, PrimalSharedPrimalLegendProfile *> *)primalLegendProfiles blossomServers:(NSDictionary<NSString *, NSArray<NSString *> *> *)blossomServers __attribute__((swift_name("mapAsProfileDataPO(_:cdnResourcesMap:primalUserNames:primalPremiumInfo:primalLegendProfiles:blossomServers:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NostrEventsKt")))
@interface PrimalSharedNostrEventsKt : PrimalSharedBase
+ (NSArray<PrimalSharedNostrEvent *> *)orderByPagingIfNotNull:(NSArray<PrimalSharedNostrEvent *> *)receiver pagingEvent:(PrimalSharedRemote_cachingContentPrimalPaging * _Nullable)pagingEvent __attribute__((swift_name("orderByPagingIfNotNull(_:pagingEvent:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NostrResourcesKt")))
@interface PrimalSharedNostrResourcesKt : PrimalSharedBase
+ (NSString *)cleanNostrUris:(NSString *)receiver __attribute__((swift_name("cleanNostrUris(_:)")));
...
+ (NSArray<PrimalSharedEventUriNostrReference *> *)flatMapMessagesAsReferencedNostrUriDO:(NSArray<PrimalSharedLocal_cachingDirectMessageData *> *)receiver eventIdToNostrEvent:(NSDictionary<NSString *, PrimalSharedNostrEvent *> *)eventIdToNostrEvent postIdToPostDataMap:(NSDictionary<NSString *, PrimalSharedLocal_cachingPostData *> *)postIdToPostDataMap articleIdToArticle:(NSDictionary<NSString *, PrimalSharedLocal_cachingArticleData *> *)articleIdToArticle profileIdToProfileDataMap:(NSDictionary<NSString *, PrimalSharedLocal_cachingProfileData *> *)profileIdToProfileDataMap cdnResources:(NSDictionary<NSString *, PrimalSharedCdnResource *> *)cdnResources linkPreviews:(NSDictionary<NSString *, PrimalSharedEventLinkPreviewData *> *)linkPreviews videoThumbnails:(NSDictionary<NSString *, NSString *> *)videoThumbnails __attribute__((swift_name("flatMapMessagesAsReferencedNostrUriDO(_:eventIdToNostrEvent:postIdToPostDataMap:articleIdToArticle:profileIdToProfileDataMap:cdnResources:linkPreviews:videoThumbnails:)")));
+ (NSArray<PrimalSharedEventUriNostrReference *> *)flatMapPostsAsReferencedNostrUriDO:(NSArray<PrimalSharedLocal_cachingPostData *> *)receiver eventIdToNostrEvent:(NSDictionary<NSString *, PrimalSharedNostrEvent *> *)eventIdToNostrEvent postIdToPostDataMap:(NSDictionary<NSString *, PrimalSharedLocal_cachingPostData *> *)postIdToPostDataMap articleIdToArticle:(NSDictionary<NSString *, PrimalSharedLocal_cachingArticleData *> *)articleIdToArticle profileIdToProfileDataMap:(NSDictionary<NSString *, PrimalSharedLocal_cachingProfileData *> *)profileIdToProfileDataMap cdnResources:(NSDictionary<NSString *, PrimalSharedCdnResource *> *)cdnResources linkPreviews:(NSDictionary<NSString *, PrimalSharedEventLinkPreviewData *> *)linkPreviews videoThumbnails:(NSDictionary<NSString *, NSString *> *)videoThumbnails __attribute__((swift_name("flatMapPostsAsReferencedNostrUriDO(_:eventIdToNostrEvent:postIdToPostDataMap:articleIdToArticle:profileIdToProfileDataMap:cdnResources:linkPreviews:videoThumbnails:)")));
...
+ (NSArray<PrimalSharedEventUriNostrReference *> *)mapAsReferencedNostrUriDO:(NSArray<NSString *> *)receiver eventId:(NSString *)eventId eventIdToNostrEvent:(NSDictionary<NSString *, PrimalSharedNostrEvent *> *)eventIdToNostrEvent postIdToPostDataMap:(NSDictionary<NSString *, PrimalSharedLocal_cachingPostData *> *)postIdToPostDataMap articleIdToArticle:(NSDictionary<NSString *, PrimalSharedLocal_cachingArticleData *> *)articleIdToArticle profileIdToProfileDataMap:(NSDictionary<NSString *, PrimalSharedLocal_cachingProfileData *> *)profileIdToProfileDataMap cdnResources:(NSDictionary<NSString *, PrimalSharedCdnResource *> *)cdnResources linkPreviews:(NSDictionary<NSString *, PrimalSharedEventLinkPreviewData *> *)linkPreviews videoThumbnails:(NSDictionary<NSString *, NSString *> *)videoThumbnails __attribute__((swift_name("mapAsReferencedNostrUriDO(_:eventId:eventIdToNostrEvent:postIdToPostDataMap:articleIdToArticle:profileIdToProfileDataMap:cdnResources:linkPreviews:videoThumbnails:)")));
+ (NSArray<PrimalSharedLocal_cachingEventUriNostr *> *)mapReferencedNostrUriAsEventUriNostrPO:(NSArray<PrimalSharedEventUriNostrReference *> *)receiver __attribute__((swift_name("mapReferencedNostrUriAsEventUriNostrPO(_:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PostDataEventsKt")))
@interface PrimalSharedPostDataEventsKt : PrimalSharedBase
+ (NSArray<PrimalSharedLocal_cachingPostData *> *)mapAsPostDataPO:(NSArray<PrimalSharedNostrEvent *> *)receiver referencedPosts:(NSArray<PrimalSharedLocal_cachingPostData *> *)referencedPosts referencedArticles:(NSArray<PrimalSharedLocal_cachingArticleData *> *)referencedArticles referencedHighlights:(NSArray<PrimalSharedLocal_cachingHighlightData *> *)referencedHighlights __attribute__((swift_name("mapAsPostDataPO(_:referencedPosts:referencedArticles:referencedHighlights:)")));
+ (NSArray<PrimalSharedLocal_cachingPostData *> *)mapNotNullAsPostDataPO:(NSArray<PrimalSharedPrimalEvent *> *)receiver referencedPosts:(NSArray<PrimalSharedLocal_cachingPostData *> *)referencedPosts referencedArticles:(NSArray<PrimalSharedLocal_cachingArticleData *> *)referencedArticles referencedHighlights:(NSArray<PrimalSharedLocal_cachingHighlightData *> *)referencedHighlights __attribute__((swift_name("mapNotNullAsPostDataPO(_:referencedPosts:referencedArticles:referencedHighlights:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PrimalEventStatsKt")))
@interface PrimalSharedPrimalEventStatsKt : PrimalSharedBase
+ (NSArray<PrimalSharedLocal_cachingEventStats *> *)mapNotNullAsEventStatsPO:(NSArray<PrimalSharedPrimalEvent *> *)receiver __attribute__((swift_name("mapNotNullAsEventStatsPO(_:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PrimalEventUserStatsKt")))
@interface PrimalSharedPrimalEventUserStatsKt : PrimalSharedBase
+ (NSArray<PrimalSharedLocal_cachingEventUserStats *> *)mapNotNullAsEventUserStatsPO:(NSArray<PrimalSharedPrimalEvent *> *)receiver userId:(NSString *)userId __attribute__((swift_name("mapNotNullAsEventUserStatsPO(_:userId:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PrimalProfileStatsAndScoresKt")))
@interface PrimalSharedPrimalProfileStatsAndScoresKt : PrimalSharedBase
+ (NSArray<PrimalSharedLocal_cachingProfileStats *> *)mapNotNullAsProfileStatsPO:(NSArray<PrimalSharedPrimalEvent *> *)receiver __attribute__((swift_name("mapNotNullAsProfileStatsPO(_:)")));
+ (NSDictionary<NSString *, PrimalSharedPrimalLegendProfile *> *)parseAndFoldPrimalLegendProfiles:(NSArray<PrimalSharedPrimalEvent *> *)receiver __attribute__((swift_name("parseAndFoldPrimalLegendProfiles(_:)")));
+ (NSDictionary<NSString *, PrimalSharedRemote_cachingContentProfilePremiumInfo *> *)parseAndFoldPrimalPremiumInfo:(NSArray<PrimalSharedPrimalEvent *> *)receiver __attribute__((swift_name("parseAndFoldPrimalPremiumInfo(_:)")));
+ (NSDictionary<NSString *, NSString *> *)parseAndFoldPrimalUserNames:(NSArray<PrimalSharedPrimalEvent *> *)receiver __attribute__((swift_name("parseAndFoldPrimalUserNames(_:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PrimalRelayHintsKt")))
@interface PrimalSharedPrimalRelayHintsKt : PrimalSharedBase
+ (NSArray<PrimalSharedLocal_cachingEventRelayHints *> *)flatMapAsEventHintsPO:(NSArray<PrimalSharedPrimalEvent *> *)receiver __attribute__((swift_name("flatMapAsEventHintsPO(_:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RepostEventsKt")))
@interface PrimalSharedRepostEventsKt : PrimalSharedBase
+ (NSArray<PrimalSharedLocal_cachingRepostData *> *)mapNotNullAsRepostDataPO:(NSArray<PrimalSharedNostrEvent *> *)receiver __attribute__((swift_name("mapNotNullAsRepostDataPO(_:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ZapEventsKt")))
@interface PrimalSharedZapEventsKt : PrimalSharedBase
+ (NSArray<PrimalSharedLocal_cachingEventZap *> *)mapAsEventZapDO:(NSArray<PrimalSharedNostrEvent *> *)receiver profilesMap:(NSDictionary<NSString *, PrimalSharedLocal_cachingProfileData *> *)profilesMap __attribute__((swift_name("mapAsEventZapDO(_:profilesMap:)")));
@end
...
- (void)cancelCause:(PrimalSharedKotlinCancellationException * _Nullable)cause __attribute__((swift_name("cancel(cause:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Remote_cachingContentPrimalEventStats.Companion")))
@interface PrimalSharedRemote_cachingContentPrimalEventStatsCompanion : PrimalSharedBase
@property (class, readonly, getter=shared) PrimalSharedRemote_cachingContentPrimalEventStatsCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<PrimalSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Local_cachingEventStats")))
@interface PrimalSharedLocal_cachingEventStats : PrimalSharedBase
@property (readonly) NSString *eventId __attribute__((swift_name("eventId")));
@property (readonly) int64_t likes __attribute__((swift_name("likes")));
@property (readonly) int64_t mentions __attribute__((swift_name("mentions")));
@property (readonly) int64_t replies __attribute__((swift_name("replies")));
...
@property (readonly) int64_t zaps __attribute__((swift_name("zaps")));
- (instancetype)initWithEventId:(NSString *)eventId likes:(int64_t)likes replies:(int64_t)replies mentions:(int64_t)mentions reposts:(int64_t)reposts zaps:(int64_t)zaps satsZapped:(int64_t)satsZapped score:(int64_t)score score24h:(int64_t)score24h __attribute__((swift_name("init(eventId:likes:replies:mentions:reposts:zaps:satsZapped:score:score24h:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedLocal_cachingEventStats *)doCopyEventId:(NSString *)eventId likes:(int64_t)likes replies:(int64_t)replies mentions:(int64_t)mentions reposts:(int64_t)reposts zaps:(int64_t)zaps satsZapped:(int64_t)satsZapped score:(int64_t)score score24h:(int64_t)score24h __attribute__((swift_name("doCopy(eventId:likes:replies:mentions:reposts:zaps:satsZapped:score:score24h:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Remote_cachingContentPrimalEventUserStats.Companion")))
@interface PrimalSharedRemote_cachingContentPrimalEventUserStatsCompanion : PrimalSharedBase
@property (class, readonly, getter=shared) PrimalSharedRemote_cachingContentPrimalEventUserStatsCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<PrimalSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Local_cachingEventUserStats")))
@interface PrimalSharedLocal_cachingEventUserStats : PrimalSharedBase
@property (readonly) NSString *eventId __attribute__((swift_name("eventId")));
@property (readonly) BOOL liked __attribute__((swift_name("liked")));
@property (readonly) BOOL replied __attribute__((swift_name("replied")));
@property (readonly) BOOL reposted __attribute__((swift_name("reposted")));
...
@property (readonly) BOOL zapped __attribute__((swift_name("zapped")));
- (instancetype)initWithEventId:(NSString *)eventId userId:(NSString *)userId replied:(BOOL)replied liked:(BOOL)liked reposted:(BOOL)reposted zapped:(BOOL)zapped __attribute__((swift_name("init(eventId:userId:replied:liked:reposted:zapped:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedLocal_cachingEventUserStats *)doCopyEventId:(NSString *)eventId userId:(NSString *)userId replied:(BOOL)replied liked:(BOOL)liked reposted:(BOOL)reposted zapped:(BOOL)zapped __attribute__((swift_name("doCopy(eventId:userId:replied:liked:reposted:zapped:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Local_cachingProfileStats")))
@interface PrimalSharedLocal_cachingProfileStats : PrimalSharedBase
@property (readonly) PrimalSharedInt * _Nullable contentZapCount __attribute__((swift_name("contentZapCount")));
@property (readonly) PrimalSharedInt * _Nullable followers __attribute__((swift_name("followers")));
@property (readonly) PrimalSharedInt * _Nullable following __attribute__((swift_name("following")));
@property (readonly) PrimalSharedLong * _Nullable joinedAt __attribute__((swift_name("joinedAt")));
...
@property (readonly) PrimalSharedLong * _Nullable totalReceivedZaps __attribute__((swift_name("totalReceivedZaps")));
- (instancetype)initWithProfileId:(NSString *)profileId following:(PrimalSharedInt * _Nullable)following followers:(PrimalSharedInt * _Nullable)followers notesCount:(PrimalSharedInt * _Nullable)notesCount readsCount:(PrimalSharedInt * _Nullable)readsCount mediaCount:(PrimalSharedInt * _Nullable)mediaCount repliesCount:(PrimalSharedInt * _Nullable)repliesCount relaysCount:(PrimalSharedInt * _Nullable)relaysCount totalReceivedZaps:(PrimalSharedLong * _Nullable)totalReceivedZaps contentZapCount:(PrimalSharedInt * _Nullable)contentZapCount totalReceivedSats:(PrimalSharedLong * _Nullable)totalReceivedSats joinedAt:(PrimalSharedLong * _Nullable)joinedAt __attribute__((swift_name("init(profileId:following:followers:notesCount:readsCount:mediaCount:repliesCount:relaysCount:totalReceivedZaps:contentZapCount:totalReceivedSats:joinedAt:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedLocal_cachingProfileStats *)doCopyProfileId:(NSString *)profileId following:(PrimalSharedInt * _Nullable)following followers:(PrimalSharedInt * _Nullable)followers notesCount:(PrimalSharedInt * _Nullable)notesCount readsCount:(PrimalSharedInt * _Nullable)readsCount mediaCount:(PrimalSharedInt * _Nullable)mediaCount repliesCount:(PrimalSharedInt * _Nullable)repliesCount relaysCount:(PrimalSharedInt * _Nullable)relaysCount totalReceivedZaps:(PrimalSharedLong * _Nullable)totalReceivedZaps contentZapCount:(PrimalSharedInt * _Nullable)contentZapCount totalReceivedSats:(PrimalSharedLong * _Nullable)totalReceivedSats joinedAt:(PrimalSharedLong * _Nullable)joinedAt __attribute__((swift_name("doCopy(profileId:following:followers:notesCount:readsCount:mediaCount:repliesCount:relaysCount:totalReceivedZaps:contentZapCount:totalReceivedSats:joinedAt:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Remote_cachingContentProfilePremiumInfo")))
@interface PrimalSharedRemote_cachingContentProfilePremiumInfo : PrimalSharedBase
@property (class, readonly, getter=companion) PrimalSharedRemote_cachingContentProfilePremiumInfoCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString * _Nullable cohort1 __attribute__((swift_name("cohort1")));
@property (readonly) NSString * _Nullable cohort2 __attribute__((swift_name("cohort2")));
@property (readonly) PrimalSharedLong * _Nullable expiresAt __attribute__((swift_name("expiresAt")));
@property (readonly) PrimalSharedLong * _Nullable legendSince __attribute__((swift_name("legendSince")));
...
- (PrimalSharedRemote_cachingContentProfilePremiumInfo *)doCopyCohort1:(NSString * _Nullable)cohort1 cohort2:(NSString * _Nullable)cohort2 tier:(NSString * _Nullable)tier expiresAt:(PrimalSharedLong * _Nullable)expiresAt legendSince:(PrimalSharedLong * _Nullable)legendSince premiumSince:(PrimalSharedLong * _Nullable)premiumSince __attribute__((swift_name("doCopy(cohort1:cohort2:tier:expiresAt:legendSince:premiumSince:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Local_cachingHighlightData")))
@interface PrimalSharedLocal_cachingHighlightData : PrimalSharedBase
...
- (PrimalSharedLocal_cachingHighlightData *)doCopyHighlightId:(NSString *)highlightId authorId:(NSString *)authorId content:(NSString *)content context:(NSString * _Nullable)context alt:(NSString * _Nullable)alt referencedEventATag:(NSString * _Nullable)referencedEventATag referencedEventAuthorId:(NSString * _Nullable)referencedEventAuthorId createdAt:(int64_t)createdAt __attribute__((swift_name("doCopy(highlightId:authorId:content:context:alt:referencedEventATag:referencedEventAuthorId:createdAt:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Local_cachingRepostData")))
@interface PrimalSharedLocal_cachingRepostData : PrimalSharedBase
@property (readonly) NSString *authorId __attribute__((swift_name("authorId")));
@property (readonly) int64_t createdAt __attribute__((swift_name("createdAt")));
@property (readonly) NSString *postAuthorId __attribute__((swift_name("postAuthorId")));
@property (readonly) NSString *postId __attribute__((swift_name("postId")));
@property (readonly) NSString *repostId __attribute__((swift_name("repostId")));
@property (readonly) NSString *sig __attribute__((swift_name("sig")));
@property (readonly) NSArray<NSArray<PrimalSharedKotlinx_serialization_jsonJsonElement *> *> *tags __attribute__((swift_name("tags")));
- (instancetype)initWithRepostId:(NSString *)repostId authorId:(NSString *)authorId createdAt:(int64_t)createdAt tags:(NSArray<NSArray<PrimalSharedKotlinx_serialization_jsonJsonElement *> *> *)tags postId:(NSString *)postId postAuthorId:(NSString *)postAuthorId sig:(NSString *)sig __attribute__((swift_name("init(repostId:authorId:createdAt:tags:postId:postAuthorId:sig:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedLocal_cachingRepostData *)doCopyRepostId:(NSString *)repostId authorId:(NSString *)authorId createdAt:(int64_t)createdAt tags:(NSArray<NSArray<PrimalSharedKotlinx_serialization_jsonJsonElement *> *> *)tags postId:(NSString *)postId postAuthorId:(NSString *)postAuthorId sig:(NSString *)sig __attribute__((swift_name("doCopy(repostId:authorId:createdAt:tags:postId:postAuthorId:sig:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Local_cachingEventUri")))
@interface PrimalSharedLocal_cachingEventUri : PrimalSharedBase
@property (readonly) NSString * _Nullable authorAvatarUrl __attribute__((swift_name("authorAvatarUrl")));
@property (readonly) NSString * _Nullable description_ __attribute__((swift_name("description_")));
@property (readonly) NSString *eventId __attribute__((swift_name("eventId")));
@property (readonly) NSString * _Nullable mimeType __attribute__((swift_name("mimeType")));
...
@property (readonly) NSString *url __attribute__((swift_name("url")));
@property (readonly) NSArray<PrimalSharedCdnResourceVariant *> * _Nullable variants __attribute__((swift_name("variants")));
- (instancetype)initWithPosition:(int32_t)position eventId:(NSString *)eventId url:(NSString *)url type:(PrimalSharedEventUriType *)type mimeType:(NSString * _Nullable)mimeType variants:(NSArray<PrimalSharedCdnResourceVariant *> * _Nullable)variants title:(NSString * _Nullable)title description:(NSString * _Nullable)description thumbnail:(NSString * _Nullable)thumbnail authorAvatarUrl:(NSString * _Nullable)authorAvatarUrl __attribute__((swift_name("init(position:eventId:url:type:mimeType:variants:title:description:thumbnail:authorAvatarUrl:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedLocal_cachingEventUri *)doCopyPosition:(int32_t)position eventId:(NSString *)eventId url:(NSString *)url type:(PrimalSharedEventUriType *)type mimeType:(NSString * _Nullable)mimeType variants:(NSArray<PrimalSharedCdnResourceVariant *> * _Nullable)variants title:(NSString * _Nullable)title description:(NSString * _Nullable)description thumbnail:(NSString * _Nullable)thumbnail authorAvatarUrl:(NSString * _Nullable)authorAvatarUrl __attribute__((swift_name("doCopy(position:eventId:url:type:mimeType:variants:title:description:thumbnail:authorAvatarUrl:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Local_cachingArticleData")))
@interface PrimalSharedLocal_cachingArticleData : PrimalSharedBase
@property (readonly) NSString *aTag __attribute__((swift_name("aTag")));
@property (readonly) NSString *articleId __attribute__((swift_name("articleId")));
@property (readonly) NSString *authorId __attribute__((swift_name("authorId")));
@property (readonly) NSString * _Nullable authorMetadataId __attribute__((swift_name("authorMetadataId")));
...
- (instancetype)initWithATag:(NSString *)aTag eventId:(NSString *)eventId articleId:(NSString *)articleId authorId:(NSString *)authorId createdAt:(int64_t)createdAt content:(NSString *)content title:(NSString *)title publishedAt:(int64_t)publishedAt raw:(NSString *)raw imageCdnImage:(PrimalSharedCdnImage * _Nullable)imageCdnImage summary:(NSString * _Nullable)summary authorMetadataId:(NSString * _Nullable)authorMetadataId wordsCount:(PrimalSharedInt * _Nullable)wordsCount uris:(NSArray<NSString *> *)uris hashtags:(NSArray<NSString *> *)hashtags __attribute__((swift_name("init(aTag:eventId:articleId:authorId:createdAt:content:title:publishedAt:raw:imageCdnImage:summary:authorMetadataId:wordsCount:uris:hashtags:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedLocal_cachingArticleData *)doCopyATag:(NSString *)aTag eventId:(NSString *)eventId articleId:(NSString *)articleId authorId:(NSString *)authorId createdAt:(int64_t)createdAt content:(NSString *)content title:(NSString *)title publishedAt:(int64_t)publishedAt raw:(NSString *)raw imageCdnImage:(PrimalSharedCdnImage * _Nullable)imageCdnImage summary:(NSString * _Nullable)summary authorMetadataId:(NSString * _Nullable)authorMetadataId wordsCount:(PrimalSharedInt * _Nullable)wordsCount uris:(NSArray<NSString *> *)uris hashtags:(NSArray<NSString *> *)hashtags __attribute__((swift_name("doCopy(aTag:eventId:articleId:authorId:createdAt:content:title:publishedAt:raw:imageCdnImage:summary:authorMetadataId:wordsCount:uris:hashtags:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Local_cachingDirectMessageData")))
@interface PrimalSharedLocal_cachingDirectMessageData : PrimalSharedBase
@property (readonly) NSString *content __attribute__((swift_name("content")));
@property (readonly) int64_t createdAt __attribute__((swift_name("createdAt")));
@property (readonly) NSArray<NSString *> *hashtags __attribute__((swift_name("hashtags")));
...
@property (readonly) NSString *senderId __attribute__((swift_name("senderId")));
@property (readonly) NSArray<NSString *> *uris __attribute__((swift_name("uris")));
- (instancetype)initWithMessageId:(NSString *)messageId ownerId:(NSString *)ownerId senderId:(NSString *)senderId receiverId:(NSString *)receiverId participantId:(NSString *)participantId createdAt:(int64_t)createdAt content:(NSString *)content uris:(NSArray<NSString *> *)uris hashtags:(NSArray<NSString *> *)hashtags __attribute__((swift_name("init(messageId:ownerId:senderId:receiverId:participantId:createdAt:content:uris:hashtags:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedLocal_cachingDirectMessageData *)doCopyMessageId:(NSString *)messageId ownerId:(NSString *)ownerId senderId:(NSString *)senderId receiverId:(NSString *)receiverId participantId:(NSString *)participantId createdAt:(int64_t)createdAt content:(NSString *)content uris:(NSArray<NSString *> *)uris hashtags:(NSArray<NSString *> *)hashtags __attribute__((swift_name("doCopy(messageId:ownerId:senderId:receiverId:participantId:createdAt:content:uris:hashtags:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Remote_cachingContentPrimalPaging")))
@interface PrimalSharedRemote_cachingContentPrimalPaging : PrimalSharedBase
@property (class, readonly, getter=companion) PrimalSharedRemote_cachingContentPrimalPagingCompanion *companion __attribute__((swift_name("companion")));
...
- (PrimalSharedRemote_cachingContentPrimalPaging *)doCopyOrderBy:(NSString *)orderBy sinceId:(PrimalSharedLong * _Nullable)sinceId untilId:(PrimalSharedLong * _Nullable)untilId elements:(NSArray<NSString *> *)elements __attribute__((swift_name("doCopy(orderBy:sinceId:untilId:elements:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Local_cachingEventUriNostr")))
@interface PrimalSharedLocal_cachingEventUriNostr : PrimalSharedBase
@property (readonly) NSString *eventId __attribute__((swift_name("eventId")));
@property (readonly) int32_t position __attribute__((swift_name("position")));
@property (readonly) PrimalSharedReferencedArticle * _Nullable referencedArticle __attribute__((swift_name("referencedArticle")));
@property (readonly) NSString * _Nullable referencedEventAlt __attribute__((swift_name("referencedEventAlt")));
...
@property (readonly) PrimalSharedEventUriNostrType *type __attribute__((swift_name("type")));
@property (readonly) NSString *uri __attribute__((swift_name("uri")));
- (instancetype)initWithPosition:(int32_t)position eventId:(NSString *)eventId uri:(NSString *)uri type:(PrimalSharedEventUriNostrType *)type referencedEventAlt:(NSString * _Nullable)referencedEventAlt referencedHighlight:(PrimalSharedReferencedHighlight * _Nullable)referencedHighlight referencedNote:(PrimalSharedReferencedNote * _Nullable)referencedNote referencedArticle:(PrimalSharedReferencedArticle * _Nullable)referencedArticle referencedUser:(PrimalSharedReferencedUser * _Nullable)referencedUser referencedZap:(PrimalSharedReferencedZap * _Nullable)referencedZap __attribute__((swift_name("init(position:eventId:uri:type:referencedEventAlt:referencedHighlight:referencedNote:referencedArticle:referencedUser:referencedZap:)"))) __attribute__((objc_designated_initializer));
- (PrimalSharedLocal_cachingEventUriNostr *)doCopyPosition:(int32_t)position eventId:(NSString *)eventId uri:(NSString *)uri type:(PrimalSharedEventUriNostrType *)type referencedEventAlt:(NSString * _Nullable)referencedEventAlt referencedHighlight:(PrimalSharedReferencedHighlight * _Nullable)referencedHighlight referencedNote:(PrimalSharedReferencedNote * _Nullable)referencedNote referencedArticle:(PrimalSharedReferencedArticle * _Nullable)referencedArticle referencedUser:(PrimalSharedReferencedUser * _Nullable)referencedUser referencedZap:(PrimalSharedReferencedZap * _Nullable)referencedZap __attribute__((swift_name("doCopy(position:eventId:uri:type:referencedEventAlt:referencedHighlight:referencedNote:referencedArticle:referencedUser:referencedZap:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Local_cachingEventRelayHints")))
@interface PrimalSharedLocal_cachingEventRelayHints : PrimalSharedBase
@property (readonly) NSString *eventId __attribute__((swift_name("eventId")));
@property (readonly) NSArray<NSString *> *relays __attribute__((swift_name("relays")));
...
- (PrimalSharedLocal_cachingEventRelayHints *)doCopyEventId:(NSString *)eventId relays:(NSArray<NSString *> *)relays __attribute__((swift_name("doCopy(eventId:relays:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Remote_cachingContentProfilePremiumInfo.Companion")))
@interface PrimalSharedRemote_cachingContentProfilePremiumInfoCompanion : PrimalSharedBase
@property (class, readonly, getter=shared) PrimalSharedRemote_cachingContentProfilePremiumInfoCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<PrimalSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Remote_cachingContentPrimalPaging.Companion")))
@interface PrimalSharedRemote_cachingContentPrimalPagingCompanion : PrimalSharedBase
@property (class, readonly, getter=shared) PrimalSharedRemote_cachingContentPrimalPagingCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<PrimalSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
